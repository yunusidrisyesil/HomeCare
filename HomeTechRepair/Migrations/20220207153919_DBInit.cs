    ...
    public partial class DBInit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReciptMasterId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("AltarnateKey_ReciptServiceId", x => new { x.ServiceId, x.ReciptMasterId });
                    table.ForeignKey(
                        name: "FK_ReciptDetails_ReciptMasters_ReciptMasterId",
                        column: x => x.ReciptMasterId,
                        principalTable: "ReciptMasters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReciptDetails_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReciptDetails_ReciptMasterId",
                table: "ReciptDetails",
