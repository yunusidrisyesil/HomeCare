...
namespace HomeTechRepair.Services
{
    public class EmailSender : IEmailSender
    {
        ...
        public string SenderMail => _configuration.GetSection
            ("EmailOptions:SenderMail").Value;
        public string Password => _configuration.GetSection
            ("EmailOptions:Password").Value;
